...
function initBQDM(data) {
    ...
    initnav.innerHTML = '<span class="logo"></span><h1>病区大屏信息交互系统</h1><h2>VISUAL NURSING INTEGRATED INFORMATION PLATFORM</h2>';
    initwrap.appendChild(initnav);

    var inithd = document.createElement('header');
    inithd.innerHTML = '<h2>病区大屏信息交互系统</h2><p>VISUAL NURSING INTEGRATED INFORMATION PLATFORM</p>';
    ...
    initfooter.innerHTML = '<span class="hosname">医院名称</span><span class="copyright">© 2017 Winning Health 版权所有</span>';
